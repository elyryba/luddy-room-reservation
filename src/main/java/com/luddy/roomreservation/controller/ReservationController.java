...
import com.luddy.roomreservation.service.EmailService;
...
public class ReservationController {
    ...
    @PostMapping("/book")
    public String bookRoom(@RequestParam Long roomId, @RequestParam String userName, @RequestParam String userEmail, @RequestParam String startTime, @RequestParam String endTime, @RequestParam String purpose, Model model) {
        try {
            ...
            try { 
                ...
                if(room != null) emailService.sendBookingConfirmation(reservation, room.getRoomNumber());
